...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 245.0, 92.0, 38.5, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 37.0, 48.0, 46.0 ],
...
, 							{
								...
								"index" : 3,
								"tag" : "in3",
								"comment" : "mute (int) 0 = bypass, 1 = mute"
							}
 ]
					}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.0, 75.0, 265.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
,
										...
										"outputs" : [ 											{
												...
												"displayName" : "mute (int) 0 = bypass, 1 = mute",
												"docked" : 0
											}
 ],
										"helpname" : "in",
...
,
									"text" : "in 3 @comment \"mute (int) 0 = bypass, 1 = mute\"",
									"varname" : "Mute"
								}
...
,
											...
											"boxes" : [ 												{
													"box" : 													{
														"maxclass" : "comment",
														"text" : "This is to smooth out the signal chain by including a 5 ms envelope (regardless of the samplerate) ",
														"linecount" : 4,
														"id" : "obj-13",
														"numinlets" : 1,
														"patching_rect" : [ 563.0, 351.0, 153.0, 60.0 ],
														"numoutlets" : 0
													}
...
, 												{
													"box" : 													{
														...
														"id" : "obj-9",
														"numinlets" : 1,
														"patching_rect" : [ 502.0, 85.0, 33.0, 22.0 ],
														"numoutlets" : 1,
														"outlettype" : [ "" ]
													}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 3 @comment \"Mute, Signal/Float 0 = unmute, 1 = mute\" @min 0 @max 1 @default 0",
														"id" : "obj-8",
														"numinlets" : 0,
														"patching_rect" : [ 502.0, 14.0, 473.0, 22.0 ],
														"numoutlets" : 1,
														"outlettype" : [ "" ]
													}
...
, 												{
													"box" : 													{
														...
														"id" : "obj-7",
														"numinlets" : 2,
														"patching_rect" : [ 411.5, 429.0, 29.5, 22.0 ],
														"numoutlets" : 1,
														"outlettype" : [ "" ]
													}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "out 2 @comment Signal-Out-Right",
														"id" : "obj-5",
														"numinlets" : 1,
														"patching_rect" : [ 413.0, 619.0, 192.0, 22.0 ],
														"numoutlets" : 0
													}
...
, 												{
													"box" : 													{
														...
														"id" : "obj-2",
														"numinlets" : 0,
														"patching_rect" : [ 305.0, 14.0, 175.0, 22.0 ],
														"numoutlets" : 1,
														"outlettype" : [ "" ]
													}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "out 1 @comment Signal-Out-Left",
														"id" : "obj-4",
														"numinlets" : 1,
														"patching_rect" : [ 154.5, 619.0, 184.0, 22.0 ],
														"numoutlets" : 0
													}
...
,
									"text" : "gen~ @title Utility-Mute",
									"varname" : "Utility-Mute"
								}
...
,
		"dependency_cache" : [ 			{
				"name" : "untitled_20231207.maxsnap",
